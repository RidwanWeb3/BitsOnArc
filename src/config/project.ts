export const CONTRACT_ADDRESS: string = "0x931b614cd9906f09c1712f85d21e0600502b3757";
...
export const project = {
  ...
  circleDevDocs: "https://developers.circle.com/",
};

export const isCaLive = CONTRACT_ADDRESS !== "COMING SOON";
